    ...
    <div className="mx-auto max-w-xl space-y-4 px-4 py-20 text-center">
      ...
      <div className="flex justify-center gap-2">
        <button
          type="button"
          onClick={reset}
          className="rounded-lg bg-primary px-4 py-2 text-sm font-medium text-primary-foreground shadow-sm hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/40"
        >
          Try again
        </button>
        <Link href="/" className="rounded-lg border bg-card px-4 py-2 text-sm shadow-sm hover:bg-accent">
          Home
        </Link>
      </div>
