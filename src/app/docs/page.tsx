...
const CHANGE_FILTERS: [string, string][] = [
  ...
  ['field', 'Relationship type code, e.g. RE8 (partner of) or RE4 (commissioned by).'],
  ['relatedGroup', 'Type of the organisation on the other side of the relationship. RE8 also links councils and trusts to ICBs, so PCN joins and leaves are field=RE8&relatedGroup=pcn&kinds=rel_added,rel_ended.'],
